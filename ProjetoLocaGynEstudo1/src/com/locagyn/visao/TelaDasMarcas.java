...
public class TelaDasMarcas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7LOGO.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
    ...
    private void jButtonIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonIncluirActionPerformed
        ...
        try {
         ...
         String filePath = "C:\\Users\\drpvr\\Desktop\\Eugenio Projetos\\ProjetoLocaGynEstudo\\src\\com\\locagyn\\arquivosdedados\\Marca.txt";   
         File file = new File(filePath);
         FileWriter fw = new FileWriter(file);
         BufferedWriter bw = new BufferedWriter(fw);
         
         for(int i = 0; i < jTableMarcas.getRowCount(); i++) {
             for(int j = 0; j < jTableMarcas.getColumnCount(); j++){
                 bw.write(jTableMarcas.getValueAt(i, j).toString().toUpperCase()+ ";");
             }
         }
    ...
    private void jButtonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarActionPerformed
        ...
        JFileChooser fc = new JFileChooser();
            ...
            iconLogo.setImage(iconLogo.getImage().getScaledInstance(jLabel7LOGO.getWidth(), jLabel7LOGO.getHeight(),1 ));
